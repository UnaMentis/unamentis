  ...
  return (
    <main className="min-h-screen">
      ...
      <div className="container mx-auto max-w-2xl space-y-6 px-4 py-6 text-sm leading-relaxed">
        <p className="text-muted-foreground">Beta draft v1.0, last updated 2026-06-10.</p>
        ...
        <div className="rounded-md border border-yellow-500/40 bg-yellow-500/10 p-4">
          ...
          <p className="text-muted-foreground">
            These terms are a placeholder for the beta. Binding terms of service have not yet been
            finalized. By using the beta you accept the factual conditions below; full legal terms
        ...
        <section className="space-y-2">
          ...
          <p>
            UnaMentis is provided as a beta for evaluation. Features may change or break, and
            availability is not guaranteed. Do not rely on it for critical needs.
          </p>
        </section>
        ...
        <section className="space-y-2">
          ...
          <p>
            You must be at least 13 years old to use UnaMentis. By registering you attest that you
        ...
        <section className="space-y-2">
          ...
          <p>
            Use UnaMentis lawfully and do not attempt to disrupt, abuse, or gain unauthorized access
            to the service or to other accounts.
          </p>
        </section>
        ...
        <section className="space-y-2">
          ...
          <p className="text-muted-foreground">
            Liability, warranty disclaimers, governing law, dispute resolution, and account
            termination terms are pending legal authoring and are intentionally omitted from this
            draft.
          </p>
        </section>
