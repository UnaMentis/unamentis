        ...
        <CardContent>
          <div className="flex flex-wrap gap-4 items-end">
            <div className="flex-1 min-w-[200px]">
              <label className="block text-sm font-medium text-slate-400 mb-2">Test Suite</label>
              <select
                value={selectedSuite}
                  ...
                  <tr key={run.id} className="border-b border-slate-800/50 hover:bg-slate-800/30">
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-2 text-sm text-slate-300">
                        <ClientTypeIcon type={run.clientType} className="w-4 h-4 text-slate-400" />
        ...
        <div className="p-4">
          {clients.length === 0 ? (
            <div className="text-center text-slate-500 py-8">
              ...
              <p className="text-sm mt-1">Start an iOS Simulator or Web client to begin testing</p>
            </div>
          ) : (
